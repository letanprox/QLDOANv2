...
var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
                ...
                if(String(this.responseURL).includes('api/sua_admin_teacher')){
...
// ///LOAD----------------------------------------------------
function loadInfo(){
    xhttp.open("GET", "/api/info_user?Ma="+MaAdmin, false);
    xhttp.send();
}
...
function updateInfo(){
    ...
    xhttp.open("GET", "/api/sua_admin_teacher?Ma="+MaAdmin+"&Ten="+Ten+"&Email="+Email+"&SDT="+SDT+"&Ngaysinh="+Ngaysinh, false);
    xhttp.send();
}
...
function LoadInfo(data){
    ...
    element = element + '<div><label class="label-title">Tên: </label><label id="label-name" >'+data.TenNV+'</label><input id="input-name" value="'+data.TenNV+'" type="text"><i id="pencil-name" class="fa fa-pencil" style="font-size:12px;" aria-hidden="true"></i></div>';
    ...
    element = element + '<div><label class="label-title">Email: </label><label id="label-emails" >'+data.Email+'</label><input id="input-emails" value="'+data.Email+'" type="text"><i id="pencil-emails" class="fa fa-pencil" style="font-size:12px;" aria-hidden="true"></i></div>';
